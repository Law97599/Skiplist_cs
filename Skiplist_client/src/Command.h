...
void Command::print_error(int error_number) {
    switch (error_number) {
        ...
        case 2 /* constant-expression */:
            cout << "(error) ERR wrong number of arguments for 'set' command"
                 << endl;
            break;
        case 3 /* constant-expression */:
            cout << "(error) ERR wrong number of arguments for 'get' command"
                 << endl;
            break;
        case 4 /* constant-expression */:
            cout << "(error) ERR wrong number of arguments for 'del' command"
                 << endl;
            break;
